...
namespace RazorClassLibrary.helpers
{
	...
	public static class ManageSnippets
	{
		...
		public static bool CreateSnippet(CustomIntelliSenseDTO customIntelliSense)
		{
			...
			string filename = @$"C:\Users\MPhil\OneDrive\Documents\CustomSnippets\CSharp\{customIntelliSense.DisplayValue}.snippet";
			try
			{
