...
namespace DataAccessLibrary.Services
{
    public class ExampleDataService : IExampleDataService
    {
        ...
        public async Task<List<ExampleDTO>> GetAllExamplesAsync(int pageNumber, int pageSize, string? serverSearchTerm)
        {
            var Examples = await _exampleRepository.GetAllExamplesAsync( pageNumber, pageSize, serverSearchTerm);
